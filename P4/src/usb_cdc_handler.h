// =============================================================================
// usb_cdc_handler.h — raw USB Host CDC-ACM byte stream
// The framed RED808 protocol is implemented by daisy_usb_transport.
// =============================================================================
#pragma once
...
// Check if the DaisyPod3 CDC device is connected
